#!/usr/bin/env python3
"""
Select vibration boundary faces from a Gmsh mesh.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Interactively select vibration boundary faces from a mesh."
    )
    ...
    parser.add_argument(
        "--surface-out",
        default="selected_vibration_faces.vtu",
